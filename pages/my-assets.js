...
export default function MyAssets() {
  ...
  if (!active) {
    return (
      <div classNameName="flex flex-col justify-center items-center flex-1">
        <h1 classNameName="py-10 text-2xl">Connect wallet to view your assets</h1>
      </div>
    );
  }
  ...
  <div className="text-center p-4 bg-black">
    © 2022 Copyright 
    <a className="text-whitehite" target="_blank" rel="noreferrer" href="https://chaintusker.com/"> Chaintusker.com </a>
      -  
    <a className="text-whitehite" target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1W1NpjLfPHpRJILTjSq2A6JPLnQ5spu2F/view"> Terms and Condtions</a>
  </div>
</footer>
      </div>
    </>
